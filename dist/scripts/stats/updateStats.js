import setInitialStats from './setInitialStats.js';
...
export const getStats = () => {
  ...
  const icon = Object.keys(general.favouriteIcon).reduce((a, b) =>
  ...
  const difficulty = Object.keys(general.favouriteDifficulty).reduce((a, b) =>
